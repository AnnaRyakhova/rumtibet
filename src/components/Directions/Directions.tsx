    ...
    return (
        <div className={styles.cardWrapper} style={{ backgroundImage: `url(${background})` }}>
            ...
            <div className={styles.cardFooter}>
                <div>
                    <Typography variant='h3' color='lightColor'>{title}</Typography>
                    <Typography variant='subtitle' color='lightColor' className={styles.subtitle}>{subtitle}</Typography>
                </div>
    ...
    return (
        <div className={cn('container', styles.wrapper)}>
            <div className={styles.text}>
                <Typography variant='accentSubtitle' color='accentColor'>по версии отдыхающих</Typography>
