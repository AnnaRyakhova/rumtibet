            ...
            <div className={styles.cardWrapper}>
                ...
                <div className={styles.textContent}>
                    <div className={styles.description}>
                        ...
                        <Typography variant='subtitle' className={styles.subtitle}>{subtitle}</Typography>
                    </div>

                    <div className={styles.cardFooter}>
                        <Typography variant='subtitle' className={styles.date}>{date}</Typography>
                        <a href={url} className={styles.url}>читать статью</a>
                    </div>
                </div>
            </div>
        </a>
        ...
        <div className={styles.root}>
            <div className={cn('container', styles.wrapper)}>
                <div className={styles.title}>
                    <Typography variant='accentSubtitle' color='accentColor'>делимся впечатлениями</Typography>
